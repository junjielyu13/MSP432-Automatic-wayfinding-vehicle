...
void halLcdPrintLineCol(char String[], uint8_t Line, uint8_t Col,
                        uint8_t TextStyle);
void initLCD();
void halLcdDrawPixel(uint16_t x, uint16_t y, uint16_t Color);
void halLcdDrawLine(uint16_t xStart, uint16_t yStart, uint16_t xEnd,
                    uint16_t yEnd, uint16_t Color);
void halLcdDrawRect(uint16_t xStart, uint16_t yStart, uint16_t xEnd,
                    uint16_t yEnd, uint16_t Color);
void halLcdDrawCircle(uint16_t x, uint16_t y, uint8_t radius, uint16_t Color);
void halLcdFillRect(uint16_t xStart, uint16_t yStart, uint16_t xEnd,
                    uint16_t yEnd, uint16_t Color);
void halLcdFillCircle(uint16_t x, uint16_t y, uint8_t radius, uint16_t Color);
void halLcdDrawImageLut(uint16_t x, uint16_t y, uint16_t w, uint16_t h,
                        uint8_t *data, uint32_t *lut, uint16_t numColors);
